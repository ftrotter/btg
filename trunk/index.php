<?php
	...
	if(!isset($key)){
		echo "you need a key, but you have one neither in your session or in your GET";
		exit();
...
<p>This system is only available to Clinicians who are either registered in the NPI database, or have a login with a hospital that accepts Federated Authentication. You must prove you are human by typing below.</p>

    <form action='index.php' method='post'>
    <p><img src='captcha_image.php?$session_name=$session_id'></p>
    <p>Enter the Captcha: <input type='text' name='keystring'></p>
    <p><input type='submit' value='I am Human and I am a clinician with the right to access this PHI'></p>
    </form>
